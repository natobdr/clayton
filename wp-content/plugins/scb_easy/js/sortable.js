          ...
          if (ngModel) {
            ...
            callbacks.start = function(e, ui) {
              ...
              ui.item.sortable = {
                ...
                //placeholder: 'scbDragHelper',//mbm
                cursorAt: { left: 1, top: 1 },//mbm
                tolerance: "pointer",//"intersect",//"pointer",//mbm
                revert: true,
                cursor: "move",
                cancel: function () {
            ...
            callbacks.activate = function(/*e, ui*/) {
              ...
              //placeholder: 'scbDragHelper'
              //element.sortable('option','placeholder','scbDragHelper');//mbm
