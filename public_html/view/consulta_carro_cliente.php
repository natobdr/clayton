                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            ...
                            <span>Carros cadastrados por clientes</span>
                        </div>
                    </div>
                    <!-- /Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_carro_cliente.php#'"><i class="icon-plus-sign"></i> Novo Carro</button>
                            </div>
                            ...
                            <div class="widget box">
                                ...
                                <div class="widget-content no-padding">
                                    ...
                                    try {
                                        ...
                                        $dados = $carroCliente->buscarCarroCliente();
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Vencimento IPVA</th>
                                                <th data-hide="phone,tablet">Seguradora</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php while ($d->valid()){ ?>
                                            <tr>
                                                <td><?php echo $d->current()->nome_cliente ?></td>
                                                <td><?php echo $d->current()->modelo ?></td>
                                                <td><?php echo $d->current()->ano_fabricacao ?></td>
                                                <td><?php echo $d->current()->placa_carro?></td>
                                                <td><?php echo date('m/Y', strtotime($d->current()->vencimento_ipva))?></td>
                                                <td><?php echo $d->current()->nome_tel_seguradora?></td>
                                            </tr>
                                            <?php
                                                $d->next();
                                            }
