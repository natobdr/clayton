...
<html lang="pt-br">
    <head>
        ...
        <title>Consulta de Defeitos</title>
                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Lista de Defeitos</h3>
                            <span>Defeitos cadastrados</span>
                        </div>
                    </div>
                    <!-- /Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_defeito.php'"><i class="icon-plus-sign"></i> Cadastrar Defeito</button>
                            </div>

                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i> Lista de Defeitos</h4>
                                ...
                                <div class="widget-content no-padding">
                                  ...
                                  <?php
                                  try {
                                      $mensagem = new Defeito;
                                      $dados = $mensagem->buscaDefeito();
                                  ...
                                  <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                      ...
                                      <tbody>
                                        <?php while ($d->valid()){ ?>
                                        <tr>
                                            <td><?php echo $d->current()->id_defeito ?></td>
                                            <td><?php echo $d->current()->nome_fabricante ?></td>
                                            <td><?php echo $d->current()->tipo_defeito ?></td>
                                            <td><?php echo $d->current()->descricao ?></td>
                                            <td><?php echo date("d-m-Y H:i:s", strtotime($d->current()->dataCadastro)) ?></td>
                                            <td>
                                                <a href="editar_defeito.php?id=<?php echo $d->current()->id_defeito ?>">
                                                  <button type="button" class="btn-sm btn-primary bs-tooltip" data-placement="top" data-original-title="Editar Mensagem"><i class="icon-edit"></i></button>
                                                </a>
                                                <a href="../controller/apagarDefeito.php?id=<?php echo $d->current()->id_defeito ?>">
                                                  <button type="button" class="btn-sm btn-danger bs-tooltip" data-placement="top" data-original-title="Excluir"><i class="icon-trash"></i></button>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php
