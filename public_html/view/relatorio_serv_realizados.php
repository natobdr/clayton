...
<?php 
    ...
    require_once '../model/ServicoRealizado.php';
?>
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=0" />
        <title>Relatório de Serviços Realizados</title>
                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <h3>Relatório de Serviços Realizados</h3>
                            <span>Todos serviços realizados</span>
                        </div>
                    </div>
                    <!-- /Page Header -->
                        ...
                        <div class="col-md-12">
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i> Relatório de Serviços</h4>
                                ...
                                <div class="widget-content no-padding">
                                    ...
                                    <?php
                                    try {
                                        $servico_realizado = new ServicoRealizado();
                                        $dados = $servico_realizado->buscarManutencao();
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-tabletools datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone,tablet">Data Serviço</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php while ($d->valid()){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo date('d-m-Y', strtotime($d->current()->dt_servico_realizado)); ?></td>
                                            </tr>
                                        <?php
                                                $d->next();
                                            }
