                        ...
                        <div class="col-md-12">
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i>Editora</h4>
                                </div>
                                <div class="widget-content">
                                    <form class="form-horizontal row-border" id="validate-1" action="../controller/cadastrarEditora.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <label class="col-md-3 control-label">Telefone: <span class="required">*</span></label>
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="button" class="btn btn-info pull-right" onClick="window.location = '.php';" ></consulta_editora> Voltar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
