                        ...
                        <div class="col-md-12">
                            <div class="widget box">
                                ...
                                <div class="widget-content">
                                  ...
                                  ?>
                                    <form class="form-horizontal row-border" id="validate-1" action="../controller/cadastrarDefeito.php" method="POST">

                                      <div class="form-group">
                                          <div class="col-md-10">
                                              <label class="col-md-3 control-label">Tipo de Defeito: <span class="required">*</span></label>
                                              <div class="col-md-6">
                                                  <input type="text" name="txtTipo" class="form-control required" maxlength="95">
                                              </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          <div class="col-md-10">
                                              ...
                                              <div class="col-md-6 clearfix">
                                                  <textarea rows="5" cols="5" name="txtDescricao" class="limited form-control" data-limit="255" required=""></textarea>
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="col-md-12 select2 full-width-fix required" name="selectFabricante" required="" aria-required="true">
                                                        <option></option>
                                                        <?php while ($d->valid()){ ?>
                                                            <option value="<?php echo $d->current()->id_fabricante ?>"><?php echo $d->current()->nome_fabricante ?></option>
                                                            <?php
                                                                    $d->next();
                                                                }
                                                          ?>
