                        ...
                        <div class="col-md-12">
                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i>Fabricante</h4>
                                </div>
                                <div class="widget-content">
                                    <form class="form-horizontal row-border" id="validate-1" action="../controller/cadastrarFabricante.php" method="POST">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="button" class="btn btn-info pull-right" onClick="window.location = 'consulta_fabricante.php';" ><i class="icon-undo"></i> Voltar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
