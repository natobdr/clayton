                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_editora.php'"><i class="icon-plus-sign"></i> Nova Editora</button>
                                <button id="bntRelatorio" type="button" class="btn btn-success"  onclick="location.href = './relatorioEditora.php'" target="_blank"><i class="icon-plus-sign"></i> Relátorio</button>
                            </div>

                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i> Lista de Editoras</h4>
                                ...
                                <div class="widget-content">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        ...
                                        <tbody>
                                            <?php while ($d->valid()){ ?>
                                            <tr>
                                                <td><?php echo $d->current()->editora_id ?></td>
                                                <td><?php echo $d->current()->editora_nome ?></td>
                                                <td><?php echo $d->current()->editora_telefone ?></td>
                                                <td>
                                                    <button type="button" class="btn-sm btn-primary bs-tooltip" data-placement="top" data-original-title="Editar Cadastro"><i class="icon-edit"></i></button>
