                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_produto.php'"><i class="icon-plus-sign"></i> Novo Produto</button>
                            </div>

                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i> Lista de Produtos</h4>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Editora</th>
                                                <th data-hide="phone">Acões</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php while ($d->valid()){ ?>
                                            <tr>
                                                <td><?php echo $d->current()->produto_id; ?></td>
