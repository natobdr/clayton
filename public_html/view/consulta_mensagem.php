...
<html lang="pt-br">
    <head>
        ...
        <title>Consulta de Mensagem</title>
                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            ...
                            <span>Mensagens cadastradas</span>
                        </div>
                    </div>
                    <!-- /Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_mensagem.php'"><i class="icon-plus-sign"></i> Nova Mensagem</button>
                            </div>

                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i> Lista de Mensagens</h4>
                                ...
                                <div class="widget-content">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        ...
                                        <tbody>
                                            <?php while ($d->valid()){ ?>
                                            <tr>
                                                <td><?php echo $d->current()->id_mensagem ?></td>
                                                <td><?php echo $d->current()->nome_mensagem ?></td>
                                                <td><?php echo $d->current()->descricao ?></td>
                                                <td><?php echo date("d-m-Y H:i:s", strtotime($d->current()->dt_cadastro)) ?></td>
                                                <td>
