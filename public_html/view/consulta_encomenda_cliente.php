                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            ...
                            <span>Encomendas cadastradas por clientes</span>
                        </div>
                    </div>
                    <!-- /Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_encomenda.php#'"><i class="icon-plus-sign"></i> Nova Encomenda</button>
                                <button id="bntRelatorio" type="button" class="btn btn-success"  onclick="location.href = './relatorioEncomenda.php'" target="_blank"><i class="icon-plus-sign"></i> Relátorio</button>
                            </div>

                            <div class="widget box">
                                <div class="widget-header">
                                    <h4><i class="icon-reorder"></i> Lista de Encomendas</h4>
                                ...
                                <div class="widget-content no-padding">
                                    ...
                                    <?php
                                    try {
                                        $encomendaCliente = new EncomendaCliente();
                                        $dados = $encomendaCliente->buscarEncomendaCliente();
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Isbn</th>
                                                <th data-hide="phone">Data Encomenda</th>
                                                <th data-hide="phone,tablet">Editora</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php while ($d->valid()){ ?>
