                ...
                <div class="container">
                    ...
                    <div class="crumbs">
                        <ul id="breadcrumbs" class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                                <a href="home.php"><?=$_SESSION['login']?></a>
                            </li>
                            <li class="current">
                        ...
                        <div class="col-md-12">
                            <div class="widget box">
                                ...
                                <div class="widget-content">
                                    <form class="form-horizontal row-border" id="validate-1" action="../controller/cadastrarProduto.php" method="POST">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="button" class="btn btn-info pull-right" onClick="window.location = 'consulta_produto.php';" ><i class="icon-undo"></i> Voltar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
