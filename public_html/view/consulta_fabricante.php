                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div style="padding: 5px 0px 5px; text-align: right;">
                                <button id="bntNovoUsuario" type="button" class="btn btn-success"  onclick="location.href = 'cadastro_fabricante.php'"><i class="icon-plus-sign"></i> Novo Fabricante</button>
                            </div>
                            ...
                            <div class="widget box">
                                ...
                                <div class="widget-content">
                                    ...
                                    try {
                                        ...
                                        $dados = $fabricante->buscarFabricante();
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable">
                                        ...
                                        <tbody>
                                            <?php while ($d->valid()){ ?>
                                            <tr>
                                                <td><?php echo $d->current()->id_fabricante ?></td>
