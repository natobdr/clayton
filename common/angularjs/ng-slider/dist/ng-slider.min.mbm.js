...
!function(a) {
    ...
    a.module("ngSlider", []).directive("slider", ["$compile", "$templateCache", "$timeout", "$window", "slider", function(b, c, d, e, f) {
            return{restrict: "AE", require: "?ngModel", scope: {options: "="}, priority: 1, link: function(g, h, i, j) {
                    function k() {
                    ...
                    if (j) {
                        ...
                        var l = !1, m = function() {
                            ...
                            var b = {from: g.options.from, to: g.options.to, step: g.options.step, smooth: g.options.smooth, limits: !0, round: g.options.round || !1, value: j.$viewValue, dimension: "", scale: g.options.scale, vertical: g.options.vertical, css: g.options.css, cb: n};
    ...
    "use strict";
    a.module("ngSlider").constant("sliderConstants", {SLIDER: {settings: {from: 1, to: 40, step: 1, smooth: !0, limits: !1, round: !1, value: "3", dimension: "", vertical: !1, calculate: !1, onstatechange: !1, callback: !1}, className: "jslider", selector: ".jslider-"}, EVENTS: {}})
}(angular), function(a) {
    "use strict";
    ...
    a.module("ngSlider").factory("sliderDraggable", ["sliderUtils", function(b) {
            ...
            return c.prototype.oninit = function() {
                ...
                if (arguments.length > 0) {
                    if (this.ptr = arguments[0], this.parent = arguments[2], !this.ptr)
                        return;
                ...
                var b = this;
                this.supportTouches_ = "ontouchend"in document, this.events_ = {click: this.supportTouches_ ? "touchstart" : "click", down: this.supportTouches_ ? "touchstart" : "mousedown", move: this.supportTouches_ ? "touchmove" : "mousemove", up: this.supportTouches_ ? "touchend" : "mouseup", mousedown: (this.supportTouches_, "mousedown")};
                ...
                this.cx = c.x - this.ptr[0].offsetLeft, this.cy = c.y - this.ptr[0].offsetTop, a.extend(this.d, {left: this.ptr[0].offsetLeft, top: this.ptr[0].offsetTop, width: this.ptr[0].clientWidth, height: this.ptr[0].clientHeight}), this.outer && this.outer.get(0) && this.outer.css({height: Math.max(this.outer.height(), $(document.body).height()), overflow: "hidden"}), this.onmousedown(b)
                ...
                if (this.is.drag) {
                    this.is.drag = !1;
                    var c = b.browser();
                    this.outer && this.outer.get(0) && (this.outer.css("mozilla" === c ? {overflow: "hidden"} : {overflow: "visible"}), this.outer.css({height: "auto"})), this.onmouseup(a)
                }
            }, c
        }])
}(angular), function(a) {
    ...
    a.module("ngSlider").factory("sliderPointer", ["sliderDraggable", "sliderUtils", function(b, c) {
            ...
            return d.prototype = new b, d.prototype.oninit = function(b, c, d, e) {
                ...
                var a = c.offset(this.parent.domNode), b = {left: a.left, top: a.top, width: this.parent.domNode[0].clientWidth, height: this.parent.domNode[0].clientHeight};
                this._parent = {offset: b, width: b.width, height: b.height}, this.ptr.addClass("jslider-pointer-hover")
                ...
                b || (this.value.origin = this.parent.prcToValue(a)), this.value.prc = a,
                        this.ptr.css(this.vertical ? {top: a + "%", marginTop: -5} : {left: a + "%"}),
    ...
    a.module("ngSlider").factory("slider", ["sliderPointer", "sliderConstants", "sliderUtils", function(b, c, d) {
            ...
            return e.prototype.init = function(b, c, d) {
                ...
                this.sizes = {domWidth: this.domNode[0].clientWidth, domHeight: this.domNode[0].clientHeight, domOffset: r}, a.extend(this.o, {pointers: {}, labels: {0: {o: j}, 1: {o: k}}, limits: {0: a.element(f[3]), 1: a.element(f[4])}, indicators: {0: n, 1: o, 2: p}}), a.extend(this.o.labels[0], {value: this.o.labels[0].o.find("span")}), a.extend(this.o.labels[1], {value: this.o.labels[1].o.find("span")}), e.settings.value.split(";")[1] || (this.settings.single = !0);
            //console.log([this.domNode,this.sizes]);    
            var s = [h, i];
                ...
                return function(b) {
                    if (!a.disabled) {
                        var c = b.target.className, e = 0;
                        c.indexOf("jslider-pointer-to") > 0 && (e = 1);
                        var f = d.offset(a.domNode), g = {left: f.left, top: f.top, width: a.domNode[0].clientWidth, height: a.domNode[0].clientHeight}, h = a.o.pointers[e];
                        return h._parent = {offset: g, width: g.width, height: g.height}, h._mousemove(b), h.onmouseup(), !1
                    }
                }
                ...
                if (this.settings.scale && this.settings.scale.length > 0) {
                    for (var a = "", b = this.settings.scale, c = (100 / (b.length - 1)).toFixed(2), d = this.settings.vertical ? "top" : "left", e = 0; e < b.length; e++)
                        a += '<span style="' + d + ": " + e * c + '%">' + ("|" != b[e] ? "<ins>" + b[e] + "</ins>" : "") + "</span>";
                    return a
                }
                return""
            }, e.prototype.onresize = function() {
                var b = this;
                this.sizes = {domWidth: this.domNode[0].clientWidth, domHeight: this.domNode[0].clientHeight, domOffset: {left: this.domNode[0].offsetLeft, top: this.domNode[0].offsetTop, width: this.domNode[0].clientWidth, height: this.domNode[0].clientHeight}}, a.forEach(this.o.pointers, function(a) {
                    b.redraw(a)
                })
                ...
                function b(a, b, d) {
                    ...
                    if(c.sizes.domHeight==0 && c.sizes.domWidth==0)//mbm fix
                    {
                        c.sizes = {
                            domWidth: c.domNode[0].clientWidth,
                            domHeight: c.domNode[0].clientHeight,
                            domOffset: {
                              left: c.domNode[0].offsetLeft,
                              top: c.domNode[0].offsetTop,
                              width: c.domNode[0].clientWidth,
                              height: c.domNode[0].clientHeight
                            }
                          };
                    }    
                    
                    var e = c.settings.vertical ? c.sizes.domHeight : c.sizes.domWidth, f = b.border + b.margin;
                    
                    
                    return 0 > f && (b.margin -= f), 
                            b.border + b.label / 2 > e ? (b.margin = 0, b.right = !0) : b.right = !1, 
                            a.o.css(c.settings.vertical ? {top: d + "%", marginLeft: "20px", marginTop: b.margin, bottom: "auto"} : {left: d + "%", marginLeft: b.margin + "px", right: "auto"}), 
                            b.right && a.o.css(c.settings.vertical ? {top: "auto", bottom: 0} : {left: "auto", right: 0}),
                            b;//, console.log('d:'+d), console.log([b,e]);
                }
                var c = this, d = this.o.labels[a.uid], e = a.value.prc, f = {label: c.settings.vertical ? d.o[0].offsetHeight : d.o[0].offsetWidth, right: !1, border: e * (c.settings.vertical ? this.sizes.domHeight : this.sizes.domWidth) / 100}, g = null, h = null;
                if (!this.settings.single && !this.settings.vertical)
                    switch (h = this.o.pointers[1 - a.uid], g = this.o.labels[h.uid], a.uid) {
                        case 0:
                            f.border + f.label / 2 > g.o[0].offsetLeft - this.sizes.domOffset.left ? (g.o.css({visibility: "hidden"}), g.value.html(this.nice(h.value.origin)), d.o.css({visibility: "visible"}), e = (h.value.prc - e) / 2 + e, h.value.prc != a.value.prc && (d.value.html(this.nice(a.value.origin) + "&nbsp;&ndash;&nbsp;" + this.nice(h.value.origin)), f.label = d.o[0].offsetWidth, f.border = e * i / 100)) : g.o.css({visibility: "visible"});
                            break;
                        case 1:
                            f.border - f.label / 2 < g.o[0].offsetLeft - this.sizes.domOffset.left + g.o[0].offsetWidth ? (g.o.css({visibility: "hidden"}), g.value.html(this.nice(h.value.origin)), d.o.css({visibility: "visible"}), e = (e - h.value.prc) / 2 + h.value.prc, h.value.prc != a.value.prc && (d.value.html(this.nice(h.value.origin) + "&nbsp;&ndash;&nbsp;" + this.nice(a.value.origin)), f.label = d.o[0].offsetWidth, f.border = e * i / 100)) : g.o.css({visibility: "visible"})
                    }
                f = b(d, f, e);
                var i = c.settings.vertical ? c.sizes.domHeight : c.sizes.domWidth;
                if (g) {
                    var j = {label: c.settings.vertical ? g.o[0].offsetHeight : g.o[0].offsetWidth, right: !1, border: h.value.prc * this.sizes.domWidth / 100};
                    f = b(g, j, h.value.prc)
                }
                this.redrawLimits()
                ...
                if (this.settings.limits) {
                    ...
                    for (var c in this.o.pointers)
                        if (!this.settings.single || 0 === c) {
                            var d = this.o.pointers[c], e = this.o.labels[d.uid], f = e.o[0].offsetLeft - this.sizes.domOffset.left, g = this.o.limits[0];
                            f < g[0].clientWidth && (b[0] = !1), g = this.o.limits[1], f + e.o[0].clientWidth > this.sizes.domWidth - g[0].clientWidth && (b[1] = !1)
                        }
                    for (var h = 0; h < b.length; h++)
                        a.element(this.o.limits[h]).addClass(b[h] ? "animate-show" : "animate-hidde")
                }
                ...
                if (this.settings.heterogeneity && this.settings.heterogeneity.length > 0)
                    ...
                    b = this.settings.from + a * this.settings.interval / 100;
                return this.round(b)
                ...
                if (this.settings.heterogeneity && this.settings.heterogeneity.length > 0)
                    ...
                    c = b.limits(100 * (a - this.settings.from) / this.settings.interval);
                return c
